...
| File | Role |
|---|---|
| `demo.sh` | one-command narrated end-to-end demo of Tasks 2 & 3 (`./demo.sh`, or `--live` to download a real OA PDF); runs against an isolated temp DB and restores the tree on exit |
